<template>
  <div class="brands">
    ...
    <div class="designeraz" id="designeraz__mainContainer" data-siteuid="aishoppingparis-fra">
      <div class="designeraz__header" id="designeraz__header" page-title="">
        <!-- <div id="breadcrumb" class="breadcrumb">
          <ul>
          </ul>
        </div> -->
        <h1 class="designeraz__header__title">品牌页</h1>
        <div class="designeraz__header__cta">
          <ul>
              <li><a href="/login">关注一个品牌</a></li>
          </ul>
        </div>
      </div>

      <div class="designeraz__filter__mobile" id="designeraz__filter__mobile">
        <form name="designer__mobile" method="get" action="#">
            <div class="selecter  cover closed" tabindex="0"><select data-mf-select="" name="designerSelect" id="designerSelect" tabindex="-1" class="cs__element">
                <option value="mens_alldesigners" selected="">所有品种</option>
            <option value="Accessories">配饰</option><option value="MensShoes">鞋</option><option value="Clothing">成衣</option><option value="MensBags">包</option><option value="Soldes">折扣</option></select><span class="cs__selected default-opt">所有品种</span><div class="cs__options"><span class="cs__item selected" data-value="mens_alldesigners">所有品种</span><span class="cs__item" data-value="MensAccessories">配饰</span><span class="cs__item" data-value="MensShoes">鞋</span><span class="cs__item" data-value="MensClothing">成衣</span><span class="cs__item" data-value="MensBags">包</span><span class="cs__item" data-value="Soldes">折扣</span></div></div>
        </form>
      </div>
      <div class="designeraz__tabs">
        <div class="tabbed tabber initialized">
          <menu class="tabber-menu">
            <ul class="tabs" id="designeraz__tabs__items__wrapper">
              <li class="designeraz__tabs__item">
                <span class="tabber-handle mobile"> 设计师 A 到 Z</span><a data-json="" data-ajax="#" data-value="mens_alldesigners" class="tabber-handle tabs__link active">设计师 A 到 Z</a>
              </li>
              <li class="designeraz__tabs__item">
                <span class="tabber-handle mobile">分类</span><a data-json="" data-ajax="#" data-value="mens_categories" class="tabber-handle tabs__link">分类</a>
              </li>
              <li class="designeraz__tabs__item">
                <span class="tabber-handle mobile">折扣</span><a data-json="" data-ajax="#" data-value="mens_saledesigners" class="tabber-handle tabs__link">折扣</a>
              </li>
            </ul>
          </menu>
        </div>
      ...
      <div class="designeraz__list" id="designeraz__list">
        <div :id="list.key" v-for="list in brands" :key="list.key" class="designeraz__list__group">
            ...
            <div v-for="item in list.value" :key="item.id">
              <router-link :to="'/mens/designers/' + item.id " class="designeraz__list__item tooltipstered">
                {{item.name}}
              </router-link>
            </div>
        </div>
...
@media (min-width: 0em) {
  ...
  .designeraz__filter__mobile .selecter .cs__selected:after,
  ...
  .designeraz__filter__mobile .selecter .cs__selected:after,
  .designeraz__filter__mobile .selecter .cs__item.selected:after,
  .designeraz__filter__mobile .selecter .cs__item:first-child:after {
    content: "";
    display: block;
    height: 15px;
  ...
  .designeraz__filter__mobile .selecter .cs__item:hover,
  .designeraz__filter__mobile .selecter .cs__item.selected:hover {
...
@media (min-width: 61.313em) {
  ...
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .mfBubble__designer.subtitle_border {
    width: 40px;
    border-top: 1px solid black;
  ...
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container.number_of_products-1,
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container.number_of_products-2,
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container.number_of_products-3 {
    padding-bottom: 18px;
  }
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
  ...
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(4),
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(5),
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(6) {
    margin-top: 18px;
  }
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(1),
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(2),
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized
    .tooltipster-content
    .image-container
    .individual_image_container:nth-child(4),
  ...
  .tooltipster-sidetip.tooltipster-noir-customized.tooltipster-bottom
    .tooltipster-arrow-border {
    border-bottom-color: #888;
  }

  .tooltipster-sidetip.tooltipster-noir-customized.tooltipster-left
    .tooltipster-arrow-border {
    border-left-color: #888;
  }

  .tooltipster-sidetip.tooltipster-noir-customized.tooltipster-right
    .tooltipster-arrow-border {
    border-right-color: #888;
  }

  .tooltipster-sidetip.tooltipster-noir-customized.tooltipster-top
    .tooltipster-arrow-border {
    border-top-color: #888;
  }
  ...
  .tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized.tooltipster-left
    .tooltipster-arrow {
    height: 25px;
    margin-left: 0;
    margin-top: -11px;
